#!/bin/bash
# CentOS 6.2 64bit Plain setup script for NiftyCloud
# 2012/04/03 @ysaotome
...
/bin/rpm -ivh http://ftp.riken.jp/Linux/dag/redhat/el6/en/${ARC}/rpmforge/RPMS/rpmforge-release-0.5.2-2.el6.rf.${ARC}.rpm
...
/bin/rpm -ivh http://ftp.riken.jp/Linux/fedora/epel/6/${ARC}/epel-release-6-7.noarch.rpm
