...
/usr/bin/yum -y --enablerepo=remi-test,remi,epel,dag install httpd.${HOST_ARC} mysql.${HOST_ARC} mysql-server.${HOST_ARC} php53.${HOST_ARC} php53-mbstring.${HOST_ARC} php53-mysql.${HOST_ARC} postfix.${HOST_ARC}
